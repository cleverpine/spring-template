...
COPY ${SERVICE_NAME}-service/pom.xml ${SERVICE_NAME}-service/
COPY ${SERVICE_NAME}-service/src ${SERVICE_NAME}-service/src/
COPY ${SERVICE_NAME}-api/pom.xml ${SERVICE_NAME}-api/
